...
- [⬇️ Download for Windows (.exe installer)](https://github.com/1j01/tracky-mouse/releases/download/v2.5.0/Tracky.Mouse-2.5.0.Setup.exe) and run the installer.
  - If you get a SmartScreen warning, click "More info" and then "Run anyway".
- [⬇️ Download for Windows (.msix)](https://github.com/1j01/tracky-mouse/releases/download/v2.5.0/Tracky.Mouse.msix)
...
- [⬇️ Download for Linux (.AppImage)](https://github.com/1j01/tracky-mouse/releases/download/v2.5.0/Tracky.Mouse-2.5.0-x64.AppImage)
...
- [⬇️ Download for Linux (.deb)](https://github.com/1j01/tracky-mouse/releases/download/v2.5.0/tracky-mouse_2.5.0_amd64.deb)
- [⬇️ Download for Linux (.rpm)](https://github.com/1j01/tracky-mouse/releases/download/v2.5.0/tracky-mouse-2.5.0-1.x86_64.rpm)

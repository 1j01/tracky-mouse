...
const keyMap = Object.fromEntries([
	...
	["Point tracking", "settings.sections.pointTracking.label"], // should also be "settings.tiltInfluence.sliderMin.alt2"
...
- In between it will behave like an automatic calibration, subtly adjusting the point tracking to match the head tilt. This works by slowing down mouse movement that is moving away from the position that would be expected based on the head tilt, and (only past 80% on the slider) actively moving towards it.`, "settings.tiltInfluence.description"],
	...
	["Movement less than this distance in pixels will be ignored.", "settings.motionThreshold.description.alt1"],
	["Speed in pixels/frame required to move the cursor.", "settings.motionThreshold.description.alt2"],
...
Helps to stabilize the cursor. However, when using point tracking in combination with head tilt, a lower value may work better since head tilt is linear, and you want the point tracking to roughly match the head tracking for it to act as a seamless auto-calibration.`, "settings.pointTracking.acceleration.description"],
	...
	["Range of horizontal head tilt that moves the cursor from one side of the screen to the other.", "settings.headTilt.horizontalRange.description.alt1"],
	["How much you need to tilt your head left and right to reach the edges of the screen.", "settings.headTilt.horizontalRange.description.alt2"],
	["How much you need to tilt your head left or right to reach the edge of the screen.", "settings.headTilt.horizontalRange.description.alt3"],
	...
	["Range of vertical head tilt required to move the cursor from the top to the bottom of the screen.", "settings.headTilt.verticalRange.description.alt1"],
	["How much you need to tilt your head up and down to reach the edges of the screen.", "settings.headTilt.verticalRange.description.alt2"],
	["How much you need to tilt your head up or down to reach the edge of the screen.", "settings.headTilt.verticalRange.description.alt3"],
	...
	["Adjusts the position of the cursor when the camera sees the head facing straight ahead.", "settings.headTilt.verticalOffset.description"],
...
⚠️ This horizontal offset is not recommended. Move the camera instead if possible. 📷`, "settings.headTilt.horizontalOffset.description"],
	...
	["Adjusts the center position of vertical head tilt.", "settings.headTilt.verticalOffset.description.alt1"],
...
You may want to turn this off if you're drawing on a canvas, or increase it if you find yourself accidentally dragging when you try to click.`, "settings.delayBeforeDragging.description"],
	...
	["Default", "settings.cameraSource.defaultCamera"],
	...
	["Failed to open camera settings:", "openCameraSettings.errors.sharedHeading"],
	["Failed to parse known cameras from localStorage:", "openCameraSettings.errors.parseKnownCameras"],
	["Open your camera's system settings window to adjust properties like brightness and contrast.", "settings.openCameraSettings.description.alt1"],
	["Opens the system settings window for your camera to adjust properties like auto-focus and auto-exposure.", "settings.openCameraSettings.description.alt2"],
	...
	["Options:", "settings.dropdownDescriptionOptionsListHeading"],
	["Camera %0", "settings.cameraSource.numberedCamera"],
	["Unavailable", "settings.cameraSource.unavailableCameraAdjective"],
	["Unavailable camera", "settings.cameraSource.unavailableCamera"],
	...
	["Please make sure no other programs are using the camera and try again.", "video.errors.retryAfterClosingOtherPrograms"],
	...
	["Later", "desktop.updater.action.doNotRestartYet"],
	...
	["Failed to install dependencies for the new version after checking it out from git.", "desktop.updater.errors.install"],
...
function listLocaleFiles() {
	return fg.sync(["core/locales/*/translation.json"], {
		cwd: rootDir,
		absolute: true,
	});
}

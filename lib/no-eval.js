...
// This is a wrapper for the library that instruments eval and Function,
// so that they do not use the real eval and Function,
// and only run code known ahead of time.
(()=> {
...
return numeric.ccsrrshiftMM(X,Y);
	...
	// ES modules would need some more consideration,
	// because you can't wrap import/export statements in a function.
	// ------------------------------------------------------------
})();
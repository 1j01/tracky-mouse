...
- [⬇️ Download for Windows (.exe installer)](https://github.com/1j01/tracky-mouse/releases/download/v3.0.0/Tracky.Mouse-3.0.0.Setup.exe) and run the installer.
  - If you get a SmartScreen warning, click "More info" and then "Run anyway".
- [⬇️ Download for Windows (.msix)](https://github.com/1j01/tracky-mouse/releases/download/v3.0.0/Tracky.Mouse.msix)
...
- [⬇️ Download for Linux (.AppImage)](https://github.com/1j01/tracky-mouse/releases/download/v3.0.0/Tracky.Mouse-3.0.0-x64.AppImage)

...
TrackyMouse._initInner = function (div, { statsJs = false }, reinit) {
	...
	const availableLanguages = [
		...
		"ar", "ar-EG", "bn", "ca", "ce", "ceb", "cs", "da", "de", "el", "emoji", "en", "es", "eu", "fa", "fi", "fr", "gu", "ha", "he", "hi", "hr", "hu", "id", "it", "ja", "jv", "ko", "mr", "nb", "nl", "pa", "pl", "pt", "pt-BR", "ro", "ru", "sk", "sl", "sr", "sv", "sw", "ta", "te", "th", "tl", "tr", "tt", "uk", "ur", "vi", "war", "zh", "zh-simplified"
		// END GENERATED
	];

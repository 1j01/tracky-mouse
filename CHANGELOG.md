...
- On Windows, when Tracky Mouse is configured to "Run at login", the mouse cursor will now become visible automatically without needing to move a physical mouse.

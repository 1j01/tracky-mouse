...
TrackyMouse._initInner = function (div, { statsJs = false }, reinit) {
	...
	const availableLanguages = [
		...
		"ar", "ar-EG", "bn", "ca", "ce", "ceb", "cs", "da", "de", "el", "en", "es", "fa", "fi", "fr", "gu", "ha", "he", "hi", "hu", "id", "it", "ja", "jv", "ko", "mr", "nb", "nl", "pa", "pl", "pt", "pt-BR", "ru", "sk", "sl", "sr", "sv", "sw", "ta", "te", "th", "tl", "tr", "uk", "ur", "vi", "war", "zh", "zh-simplified"
		// END GENERATED
	];
